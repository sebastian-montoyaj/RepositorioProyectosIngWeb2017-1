...
public class ClienteDAOImpl implements ClienteDAO
{
	...
	public List<Cliente> obtener() throws Excepcion
	{
		...
		try
		{
			...
			criteria.addOrder(Order.asc("fechaCreacion")); // Y dichas estas tuplas se ordenaran ascendentemente por la fecha de creacion 
	...
	public void guardar(Cliente cliente) throws Excepcion
	{
		...
		try
		{
			...
			session.saveOrUpdate(cliente); // Se guarda el cliente en la BD
